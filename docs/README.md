...
Level 1 referrals are direct-only. Members can copy patient, clinic, laboratory, and pharmacy invite links, review backend-owned qualification progress, and see ledger-backed points and safe referral history. Registration captures optional referral attribution without treating it as access authority. Redemption, cash withdrawal, Health Check points spending, Level 2, downlines, and network earnings are deferred.
