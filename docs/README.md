...
Level 1 referrals are direct-only. Members can copy patient, clinic, laboratory, and pharmacy invite links, review backend-owned qualification progress, and see ledger-backed points and safe referral history. USER accounts can request manual cash withdrawal; points are reserved while operations transfers externally and records the outcome. SmartClinic does not automatically transfer funds or verify bank ownership. Health Check points spending, Level 2, downlines, and network earnings remain deferred.
