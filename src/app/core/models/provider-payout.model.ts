...
export interface ProviderPayout{readonly reference:string;readonly currency:string;readonly totalAmountMinor:number;readonly earningCount:number;readonly status:ProviderPayoutStatus;readonly settlementMethod:ProviderPayoutSettlementMethod;readonly externalReference:string|null;readonly note:string|null;readonly createdAt:string;readonly processingAt:string|null;readonly completedAt:string|null;readonly failedAt:string|null;readonly cancelledAt:string|null;readonly updatedAt:string;}
...
export interface CreateProviderPayoutRequest{readonly providerReference:string;readonly currency:string;readonly earningReferences:readonly string[];readonly settlementMethod:ProviderPayoutSettlementMethod;readonly note?:string;}
