...
import { ReferralHistoryFilters, ReferralHistoryResponse, ReferralImpact, ReferralLeaderboardPreference, ReferralSummary } from '../models/referral.model';
...
export class ReferralsApiService {
  ...
  getMyImpact(): Observable<ReferralImpact> { return this.http.get<ReferralImpact>(`${this.base}/me/impact`); }
  updateLeaderboardPreference(publicLeaderboard: boolean): Observable<ReferralLeaderboardPreference> { return this.http.patch<ReferralLeaderboardPreference>(`${this.base}/me/referrals/preferences`, { publicLeaderboard }); }
