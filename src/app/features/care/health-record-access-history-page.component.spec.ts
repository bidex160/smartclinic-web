...
describe('HealthRecordAccessHistoryPageComponent', () => {
  it('renders actual provider access without manufacturing grant lifecycle events', async () => {
    const item = { provider: { providerReference: 'SCPR-1', displayName: 'Prime Clinic', providerType: 'CLINIC' }, clinicalRecord: { reference: 'SC-CLR-1', title: 'Lab result', recordType: 'LAB_RESULT' }, action: 'VIEW', createdAt: '2026-09-04T10:00:00Z' };
