...
describe('ExternalFastTrackPageComponent', () => {
  it('shows only backend FastTrack offerings and submits references without a fee', async () => {
    const provider = {providerReference:'SCPR-ABCDEF0123456789',displayName:'Dynamic Clinic',providerType:'CLINIC',location:{city:'Ibadan',stateOrRegion:'Oyo',countryCode:'NG'},locations:[],services:[{code:'DENTAL',name:'Dental care',description:null,priceMinor:null,currency:null,priceOnRequest:true,supportsAppointmentRequests:true,supportsFastTrack:true,fastTrackFeeMinor:5000,fastTrackCurrency:'NGN'},{code:'GENERAL',name:'General consultation',description:null,priceMinor:null,currency:null,priceOnRequest:true,supportsAppointmentRequests:true,supportsFastTrack:false,fastTrackFeeMinor:null,fastTrackCurrency:null}]};
