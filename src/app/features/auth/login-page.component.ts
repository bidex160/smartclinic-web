  ...
  template: `
    ...
    >
      ...
      >
        ...
        <section class="auth-form-enter flex items-center">
          <div
          ...
          >
            <div>
              ...
              <h1 class="mt-5 text-3xl font-bold text-brand-900">Welcome back</h1>

              <p class="mt-3 leading-7 text-slate-600">
                Sign in with the email address or phone number linked to your SmartClinic account.
              </p>
            </div>
