      ...
      <div class="border-t border-slate-100 px-4 py-4">
        ...
        >
          ...
          @if (operational()) {
            ...
            <a routerLink="/provider/payout-accounts" routerLinkActive="!bg-brand-700 !text-white" class="flex min-h-11 items-center rounded-xl px-4 py-3 text-sm font-semibold text-brand-100 transition hover:bg-brand-800 hover:text-white focus:outline-none focus:ring-1 ml-2 focus:ring-brand-700">Payout Accounts</a>
