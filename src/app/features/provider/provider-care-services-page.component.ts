...
export class ProviderCareServicesPageComponent {
  ...
  readonly form = this.fb.nonNullable.group({
    ...
    inPersonCurrency: ['NGN', [Validators.maxLength(3)]],
    inPersonPrice: [''],
    virtualCurrency: ['NGN', [Validators.maxLength(3)]],
    virtualPrice: [''],
    homeVisitCurrency: ['NGN', [Validators.maxLength(3)]],
    homeVisitPrice: [''],
    supportsFastTrack: [false],
    fastTrackCurrency: ['NGN', [Validators.maxLength(3)]],
    fastTrackFee: [''],
  });
  ...
  openCreate() {
    ...
    this.form.reset({
      ...
      description: '',
      supportsAppointmentRequests: false,
      inPersonCurrency: 'NGN',
      inPersonPrice: '',
      virtualCurrency: 'NGN',
      virtualPrice: '',
      homeVisitCurrency: 'NGN',
      homeVisitPrice: '',
      supportsFastTrack: false,
